...
Check the [syllabus](https://uo-datasci-specialization.github.io/c1-intro-fall-2021/syllabus.html) for Presentation and Final Paper scoring rubrics
...
* Open R Project in your *.green[local]*
...
xaringanBuilder::build_pdf(here::here("slides", "w9_factors.Rmd"), complex_slides = TRUE)
```
