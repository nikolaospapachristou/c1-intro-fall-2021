...
*  only one team (your choice)
  + (try to you select a team that is currently still around, or it probably won't be interesting; see a list of current teams at [http://www.espn.com/mlb/teams](http://www.espn.com/mlb/teams)).
