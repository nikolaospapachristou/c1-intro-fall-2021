...
`nrow(student)` rows in the joined data. That is different than the number of rows in the studentInfo data (`nrow(studentinfo)` rows) because one student could take multiple assessments, so the studentAssessment added more rows per student, representing additional assessments.
