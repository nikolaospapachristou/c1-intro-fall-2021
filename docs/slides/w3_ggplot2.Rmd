...
.lightorange[geom_function()] = the `geom`etrics of the plot; the ".lightorange[function]" here represents any of the geom offerings

--

.footnote[
.pink[+] = note the .pink[+] and <ins>NOT</ins> the `%>%`
]
...
* Supplemental Learning
  ...
  + [Codecademy: Aggregates in R](https://www.codecademy.com/courses/learn-r/lessons/r-aggregates/exercises/introduction)
* Homework
  + **Homework 2**
  + **Homework 3**
